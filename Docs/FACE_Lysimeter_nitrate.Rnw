...
%%% Summary stats %%%
<<Stat_FACE_Lys_Nitrate_D_preCO2_1, echo=TRUE, results='markup'>>=
# The initial model is:
Iml_D_pre$call

<<Stat_FACE_Lys_Nitrate_D_preCO2_2, echo=TRUE, results='asis'>>=
xtable(Anova(Iml_D_pre), floating = FALSE)

<<Stat_FACE_Lys_Nitrate_D_preCO2_3, echo=TRUE, results='markup'>>=
# The final model is :
Fml_D_pre$call

<<Stat_FACE_Lys_Nitrate_D_preCO2_4, echo=TRUE, results='asis'>>=
...
%%% Summary stats %%%
<<Stat_FACE_Lys_Nitrate_D_postCO2_1, echo=TRUE, results='markup'>>=
# The initial model is:
Iml_D_post$call

<<Stat_FACE_Lys_Nitrate_D_postCO2_2, echo=FALSE, results='asis'>>=
xtable(Anova(Iml_D_post), floating = FALSE)

<<Stat_FACE_Lys_Nitrate_D_postCO2_3, echo=TRUE, results='markup'>>=
# The final model is :
Fml_D_post$call

<<Stat_FACE_Lys_Nitrate_D_postCO2_4, echo=FALSE, results='asis'>>=
