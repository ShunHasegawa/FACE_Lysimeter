...
printTbl(TrtSmmryTbl[[6]], 
         caption = "CO2 trt mean of IC in soil water",
         label = "table:FACE_CO2_Lys_IC")
@
...
printRngTbl(RngSmmryTbl[[6]], 
            caption = "Ring mean of IC in soil water", 
            label = "table:FACE_Ring_Lys_IC",
            size = "small")
@
