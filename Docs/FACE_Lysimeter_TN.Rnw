...
printTbl(TrtSmmryTbl[[7]], 
         caption = "CO2 trt mean of TN in soil water",
         label = "table:FACE_CO2_Lys_TN")
@
...
printRngTbl(RngSmmryTbl[[7]], 
            caption = "Ring mean of TN in soil water", 
            label = "table:FACE_Ring_Lys_TN",
            size = "small")
@
