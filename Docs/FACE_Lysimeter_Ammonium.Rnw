...
<<Fig_FACE_CO2_Lys_Ammonium, echo=FALSE, fig.height=3, fig.width=6>>=
TrtFg[[2]]
@
...
printTbl(TrtSmmryTbl[[3]], 
         caption = "CO2 trt mean of Ammonium in soil water at a shllow layser",
         label = "table:FACE_CO2_Lys_Ammonium_S")
printTbl(TrtSmmryTbl[[4]], 
         caption = "CO2 trt mean of Ammonium in soil water at a deep layser",
         label = "table:FACE_CO2_Lys_Ammonium_D")
@
...
<<Fig_FACE_Ring_Lys_Ammonium, echo=FALSE, fig.height=6, fig.width=6>>=
RngFg[[2]]
@
...
printLysTbl(data = RngSmmryTbl, pos = 3, variable = "Ammonium", site = "FACE_Ring", size = "small")
@
